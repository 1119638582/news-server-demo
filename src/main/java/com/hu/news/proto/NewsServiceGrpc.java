...
public final class NewsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.hu.news.proto.NewsProto.NewsRequest,
      com.hu.news.proto.NewsProto.NewsRespose> getListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "list",
      requestType = com.hu.news.proto.NewsProto.NewsRequest.class,
      responseType = com.hu.news.proto.NewsProto.NewsRespose.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.hu.news.proto.NewsProto.NewsRequest,
      com.hu.news.proto.NewsProto.NewsRespose> getListMethod() {
    io.grpc.MethodDescriptor<com.hu.news.proto.NewsProto.NewsRequest, com.hu.news.proto.NewsProto.NewsRespose> getListMethod;
      ...
      synchronized (NewsServiceGrpc.class) {
        if ((getListMethod = NewsServiceGrpc.getListMethod) == null) {
          NewsServiceGrpc.getListMethod = getListMethod =
              io.grpc.MethodDescriptor.<com.hu.news.proto.NewsProto.NewsRequest, com.hu.news.proto.NewsProto.NewsRespose>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "list"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hu.news.proto.NewsProto.NewsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hu.news.proto.NewsProto.NewsRespose.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.hu.news.proto.NewsProto.StringRequest,
      com.hu.news.proto.NewsProto.StringResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = com.hu.news.proto.NewsProto.StringRequest.class,
      responseType = com.hu.news.proto.NewsProto.StringResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.hu.news.proto.NewsProto.StringRequest,
      com.hu.news.proto.NewsProto.StringResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<com.hu.news.proto.NewsProto.StringRequest, com.hu.news.proto.NewsProto.StringResponse> getHelloMethod;
    if ((getHelloMethod = NewsServiceGrpc.getHelloMethod) == null) {
      synchronized (NewsServiceGrpc.class) {
        if ((getHelloMethod = NewsServiceGrpc.getHelloMethod) == null) {
          NewsServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<com.hu.news.proto.NewsProto.StringRequest, com.hu.news.proto.NewsProto.StringResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hu.news.proto.NewsProto.StringRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hu.news.proto.NewsProto.StringResponse.getDefaultInstance()))
  ...
  public static abstract class NewsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void list(com.hu.news.proto.NewsProto.NewsRequest request,
        io.grpc.stub.StreamObserver<com.hu.news.proto.NewsProto.NewsRespose> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getListMethod(), responseObserver);
    }

    /**
     */
    public void hello(com.hu.news.proto.NewsProto.StringRequest request,
        io.grpc.stub.StreamObserver<com.hu.news.proto.NewsProto.StringResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.hu.news.proto.NewsProto.NewsRequest,
                com.hu.news.proto.NewsProto.NewsRespose>(
                  this, METHODID_LIST)))
          .addMethod(
            getHelloMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.hu.news.proto.NewsProto.StringRequest,
                com.hu.news.proto.NewsProto.StringResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class NewsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<NewsServiceBlockingStub> {
    ...
    /**
     */
    public com.hu.news.proto.NewsProto.NewsRespose list(com.hu.news.proto.NewsProto.NewsRequest request) {
    ...
    /**
     */
    public com.hu.news.proto.NewsProto.StringResponse hello(com.hu.news.proto.NewsProto.StringRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class NewsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<NewsServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hu.news.proto.NewsProto.NewsRespose> list(
        com.hu.news.proto.NewsProto.NewsRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hu.news.proto.NewsProto.StringResponse> hello(
        com.hu.news.proto.NewsProto.StringRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST:
          serviceImpl.list((com.hu.news.proto.NewsProto.NewsRequest) request,
              (io.grpc.stub.StreamObserver<com.hu.news.proto.NewsProto.NewsRespose>) responseObserver);
          break;
        case METHODID_HELLO:
          serviceImpl.hello((com.hu.news.proto.NewsProto.StringRequest) request,
              (io.grpc.stub.StreamObserver<com.hu.news.proto.NewsProto.StringResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class NewsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.hu.news.proto.NewsProto.getDescriptor();
    }
